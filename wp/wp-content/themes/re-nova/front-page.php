                ...
                <div class="swiper-container">
                  <div class="swiper-wrapper">
                    <div class="swiper-slide">
                      <picture>
                        <source media="(max-width: 768px)" srcset="<?php echo esc_url(get_template_directory_uri()); ?>/assets/img/top/top_mphoto01_sp.jpg" >
                        <img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/img/top/top_mphoto01.jpg" alt="">
                      </picture>
                    </div>
                  </div>
                </div>
            ...
            <div class="top-sec-3__inr">
              ...
              <div class="blks-2">
                ...
                <div class="btns">
                  ...
                  <div class="btns__item _t3"><a href="https://renova-kitayama.studio.site" target="_blank" class="m-btn-1"><span class="m-btn-1__arr"></span><span class="m-btn-1__txt">店舗情報はこちら</span></a></div>
                </div>
              </div><!-- / .blks-2 -->
            </div><!-- / .top-sec-3__inr -->
          </div><!-- / .top-sec-3 -->
